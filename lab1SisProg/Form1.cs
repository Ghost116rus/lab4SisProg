                ...
                case 0:
                    {
                        if (currentRow + 1 <= sourceCodeArray.GetLength(0))
                        {
                            ...
                            if (!fsp.DoPass(sourceCodeArray, operationCodeArray, symbolTableDataGrid, binaryCodeTextBox, currentRow))
                            {
                ...
                case 2:
                    {
                        for (int i = currentRow; i <= sourceCodeArray.GetLength(0); i++)
                        {
                            ...
                            {
                                if (!fsp.DoPass(sourceCodeArray, operationCodeArray, symbolTableDataGrid, binaryCodeTextBox, i))
                                {
                                    writeError(firstPassErrorTextBox, fsp.errorText);
                                    return false;
                                }
